			...
			<?php foreach( $articles as $article) { ?>
			    <div class="article-block">
			        <div class="article-titles">
			            <h3 class="main-article-title"><a href="<?php echo $article['href'];?>"><?php echo $article['name'];?></a></h3>
			        </div>
		            <div class="article-content">
	                    <a href="<?php echo $article['href'];?>" class="artimg">
	                    	<img class="article-img" src="<?php echo $article['original']; ?>">
	                    </a>
                    	...
                    	<div class="comment-block">
                    	    <div class="comment-amount">
                    	        ...
                    	        <span><a href="<?php echo $article['href'];?>#disqus_thread">Комментировать</a></span>
                    	    </div>
                 		</div>
		            </div>
			    </div>
