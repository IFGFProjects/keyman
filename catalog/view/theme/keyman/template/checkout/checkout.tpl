...
<section class="category-title">
    <h1 class="ttu h1"><span>Оформление заказа</span></h1>
</section>

<section class="checkout-block checkout_form">
    <div class="container-fluid">
        <div class="col-sm-6">
           <div class="form-group">
               <select class="form-control input-lg" name="shipping_method" >
            ...
            <div class="form-group">
                ...
                <input type="text" name="firstname" value="<?php if (isset($address['firstname'])) echo $address['firstname']; elseif (isset($firstname)) echo $firstname; ?>" placeholder="<?php echo str_replace(':','',$entry_firstname); ?>" id="input-payment-firstname" class="form-control input-lg" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
              </div>
              <div class="form-group">
                <!-- <input type="text" class="form-control input-lg" placeholder="Фамилия:"> -->
                <input type="text" name="lastname" value="<?php if (isset($lastname)) echo $lastname;?>" placeholder="<?php echo str_replace(':','',$entry_lastname); ?>" id="input-payment-lastname" class="form-control input-lg" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
                  <!-- <input type="hidden" name="fax" value="<?php if (isset($fax)) echo $fax;?>" placeholder="<?php echo str_replace(':','',$entry_fax); ?>" id="input-payment-fax" class="form-control" <?php if (isset($customer_id)) {?> readonly<?php }?>/> -->
                </div>
        </div>
        
        <div class="col-sm-6">
           <div class="form-group">
               <select class="form-control input-lg" name="payment_method">
               	<option value="">Способ оплаты</option>
               	<?php foreach ($payment_methods as $payment_method) { ?>
               	    <?php if (!isset($payment_code)) { ?>
               	    <?php $payment_code = $payment_method['code']; ?>
               	    <option value="<?php echo $payment_method['code']; ?>" checked="checked"><?php echo $payment_method['title']; ?></option>
               	    <?php } else { ?>
                ...
                <div class="form-group">
                <!-- <input type="text" class="form-control input-lg" placeholder="Номер телефона  :"> -->
                <input type="text" name="email" value="<?php if (isset($email)) echo $email;?>" placeholder="<?php echo str_replace(':','',$entry_email); ?>" id="input-payment-email" class="form-control input-lg" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
              </div>
              <div class="form-group">
                <!-- <input type="text" class="form-control input-lg" placeholder="Адрес доставки:"> -->
                <input type="text" name="telephone" value="<?php if (isset($telephone)) echo $telephone;?>" placeholder="<?php echo str_replace(':','',$entry_telephone); ?>" id="input-payment-telephone" class="form-control input-lg" <?php if (isset($customer_id)) {?> readonly<?php }?>/>
              </div>
        </div>
        ...
        <div class="clearfix"></div>
                ...
                <input type="radio" name="payment_address" value="existing" checked="checked" onclick="jQuery('#payment-address-new').hide()" />
           		  <input type="radio" name="shipping_address" value="existing" checked="checked" onclick="jQuery('#payment-address-new').hide()" />
           	    ...
           	    <?php if (isset($customer_id)) {?>	  
           	      ...
           	      <?php } ?>
           	        ...
           	        <div class="col-sm-6">
           	           <div class="form-group">
           	          	<input type="text" name="address_1" value="<?php if (isset($address_1)) echo $address_1;?>" placeholder="<?php echo str_replace(':','',$entry_address_1); ?>" id="input-payment-address-1" class="form-control input-lg"  />
           	          	</div>

           	            <div class="form-group">
           	            		<select name="zone_id" id="input-payment-zone" class="form-control input-lg">
           	            			<option value=""> --- Выберите--- </option>
           	            			<option value="339">Горад Минск</option>
           	           ...
           	           <div class="col-sm-6">
           	             <div class="form-group">
           	             	<input type="text" name="city" value="<?php if (isset($city)) echo $city;?>" placeholder="<?php echo str_replace(':','',$entry_city); ?>" id="input-payment-city" class="form-control input-lg" />
           	             </div>
           	             <div class="form-group">
           	           		<input type="text" name="postcode" value="<?php if (isset($postcode)) echo $postcode;?>" placeholder="<?php echo str_replace(':','',$entry_postcode); ?>" id="input-payment-postcode" class="form-control input-lg" />
           	           	 </div>
           	           </div>
        ...
        <div class="col-sm-12">
           <div class="form-group">
            <textarea class="form-control input-lg" name="comment" placeholder="Комментарий к заказу:" rows="3"></textarea>
          </div>
        </div>
    </div>
</section>
        ...
        <table class="table table-bordered mincart bigcart">
         <tr> 
          ...
          <tr>
            ...
            <td class="count">
                  <input type="hidden" name="price_nt<?php echo $product['cart_id']; ?>" value="<?php echo $product['price_orig']; ?>" id="price_nt<?php echo $product['cart_id']; ?>" class="prod_price">
...
<!--     <div class="coupon">
   ...
   <div>
    <!-- <button type="submit" class="btn btn-lg ttu btn-primary" value="<?php echo $button_continue; ?>" id="button-payment-method" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>">Оформить заказ</button> -->
    <input onmousedown="$('select[name=\'payment_method\']').change();$('select[name=\'shipping_method\']').change();" type="button" class="btn btn-lg ttu btn-primary" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" id="button-register" value="<?php echo $heading_title;?>">
       </div>
    </div>
    </div>
    </div>
...
<!-- -------------------------------------------------------------------------- -->
<div class="container" style="margin-top:300px; display:none;">        
		<div class="row">
		    <div class="col-md-12">
			   ...
			   <?php //}?>
				...
				<div class="your_order">
					...
					<div class="payment clearfix">
					    ...
					    <input type="button" class="btn btn-primary" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'Загрузка ...' ?>" id="button-register" value="<?php echo $heading_title;?>">
					    <?php }?></div>
					</div>
			    </div>
			</div>
...
$("select[name='payment_method']").on('change', function() {
	$("[name='payment_method'][value='"+$(this).val()+"']").click();
	console.log("[name='payment_method'][value='"+$(this).val()+"']");
	console.debug(this);
	});

$("select[name='shipping_method']").on('change', function() {
	$("[name='shipping_method'][value='"+$(this).val()+"']").click();
	console.log("[name='shipping_method'][value='"+$(this).val()+"']");
	console.debug(this);
	});
// Login
