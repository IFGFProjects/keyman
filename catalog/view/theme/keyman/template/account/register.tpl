...
<section class="user-cabinet-block">
  ...
  <div class="user-details">
      <h3 class="user-cabinet-title">Регистрация</h3>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-email"><?php echo $entry_email; ?><span class="required">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-firstname">ФИО <span class="required">*</span></label>            
              <div class="col-sm-4">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-telephone"><?php echo $entry_telephone; ?><span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="tel" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control" required />
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-password"><?php echo $entry_password; ?><span class="required">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-confirm"><?php echo $entry_confirm; ?><span class="required">*</span></label>
            <div class="col-sm-9">
        ...
        <fieldset id="address">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-zone">Область:<span class="required">*</span></label>
            <div class="col-sm-9">
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-city"><?php echo $entry_city; ?><span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="text" name="city" value="<?php echo $city; ?>" placeholder="г. Минск, Минский район" id="input-city" class="form-control" required />
              <?php if ($error_city) { ?>
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-postcode"><?php echo $entry_postcode; ?><span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="54645" id="input-postcode" class="form-control" required />
          ...
          <div class="form-group required">
            <label class="col-sm-3 control-label" for="input-address-1">Улица<span class="required">*</span></label>
            <div class="col-sm-9">
              <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="Ивановская, ул." id="input-address-1" class="form-control" required />
    ...
    <div class="form-group">
      <div class="col-sm-9 col-sm-offset-3 col-xs-offset-0">
        <div class="address-form">
          ...
          <?php if ($custom_field['type'] == 'text') { ?>
          <!-- <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>"> -->
            <label class="control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>">
              <?php echo $custom_field['name']; ?>

              <input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo (isset($register_custom_field[$custom_field['custom_field_id']]) ? $register_custom_field[$custom_field['custom_field_id']] : $custom_field['value']); ?>" placeholder="1" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
      ...
      <div class="clearfix"></div>  
        ...
        <div class="form-group">
          <div class="col-sm-9 col-sm-offset-3 col-xs-offset-0 col-xs-12">
            <input type="submit" value="Зарегистрироваться" class="btn btn-primary ttu btn-lg mt10 registr_button" />
          </div>
        </div>
        <?php } ?>
        <input type="input" name="keyman_check_user" style="display: none;" required>
        <input type="input" name="chp" style="display: none;" value="chp">
      </form>
    </div>
    </div>
  </div>
...
$(document).ready(function(){
  $('input[name="keyman_check_user"]').remove();
  $('.registr_button').on('click', function(){
    $('input[name="chp"]').attr('value', 'clm');
  }) 
});
