...
<style>
  ...
  /*http://dev.keyman.by/image/catalog/Collections/FW19-006-2.jpg*/
  /*http://dev.keyman.by/image/catalog/Collections/FW19-015-2.jpg*/
  /*http://dev.keyman.by/image/catalog/Collections/FW19-017-2.jpg*/
</style>
...
<section class="blog-page-block">
     <div class="container-fluid">
         ...
         <div class="col-sm-12">
         <div class="row">
       <div class="blog-page-article article_new">
           <h1 class="blog-article-title text-center"><?php echo $blog['title'];?></h1>


          
           <video class="video_article" width="100%" controls="controls" poster="../video/Lookbook_W_19_20.JPG">
                  <source src="../video/<?php echo $blog['video_code'];?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
           </video>
