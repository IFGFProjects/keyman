        ...
        <div class="article-titles">
            ...
            <?php if( !empty($blog['tags']) ) { ?>
               <div class="article-tags">
                   <span>Тэги:</span>
                   	<?php 	$i = 1; foreach( $blog['tags'] as $tag => $tagLink ) { ?>
                   		<a href="<?php echo $tagLink; ?>" title="<?php echo $tag; ?>"><?php echo $tag; ?></a><?php if($i<count($blog['tags'])) { echo ", "; }; ?>
                   	<?php $i++; }  ?>
               </div>
            <?php } ?>
        </div>
                    ...
                    <?php if( $config->get('blog_show_comment_counter') ) { ?>
                    	<div class="comment-block">
                    	    <div class="comment-amount">
                    	        <a href="#">
                    	            <img src="https://keyman.by/catalog/view/theme/keyman/image/icon-comment.png">
                    	            <!-- <span><?php echo $blog['comment_count'];?></span> -->
                    	        </a> 
                    	        <span><a href="<?php echo $blog['link'];?>#disqus_thread">Комментировать</a></span>
                    	    </div>
                 		</div>
                    <?php } ?>	
            </div>
            ...
            <ul>
                ...
                <div class="tegs-block">
                    ...
                    <div class="tags">
                    	...
                    	<?php }  ?>
        <!--                 <a href="#" style="font-size:2.15em;">Шапки</a>
                        <a href="#" style="font-size:2.15em;">Туфли</a>
                        <a href="#" style="font-size:2.15em;">Брюки</a>
                        <a href="#" style="font-size:1.25em;">Мужская одежда</a>
                        <a href="#" style="font-size:1.25em;">Рубашки</a>
                        <a href="#" style="font-size:1.25em;">Стиль</a>
                        <a href="#">Головные уборы</a>
                        <a href="#">Джентельмен</a>
                        <a href="#">Фасон</a> -->
                    </div>
                </div>
    </div>
