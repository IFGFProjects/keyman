    ...
    ! function() {
        ...
        b.prototype.init = function() {
            ...
            if (!k.$slide.eq(b).hasClass("lg-loaded")) {
                ...
                } else q ? (k.$slide.eq(b).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), k.$el.trigger("hasVideo.lg", [b, f, j])) : k.$slide.eq(b).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + f + '" title="'+k.$items.eq(b)[0].title+'" alt="'+k.$items.eq(b)[0].title+'" /></div>');
