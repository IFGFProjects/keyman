...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$Year_of_birth=1950;
		if (isset($data['custom_field']['account'][6]))
			{$Year_of_birth=substr($data['custom_field']['account'][6], -4);}
		$this->model_module_bitproapi->AddClient(array(
			"@fio" => $data['firstname']." ".$data['lastname'],
			"@AdressPropiski" => $data['address_1'],
			"@postAdress" => $data['postcode'],
			"@Mail" => $data['email'],
			"@phone" => $data['telephone'],
			"@klbarcode" => isset($data['custom_field']['account'][1]) ? $data['custom_field']['account'][1] : '',
	...
	public function editCustomer($data) {
		...
		foreach ($this->model_account_address->getAddresses() as $key => $adr)
		{
			$data['address_1']=$adr['address_1'];
			$data['postcode']=$adr['postcode'];
			break;
		}
		
		$Year_of_birth=1950;
		if (isset($data['custom_field'][6]))
			{$Year_of_birth=substr($data['custom_field'][6], -4);}
