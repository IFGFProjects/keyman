...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate() && $this->request->post['chp'] == 'clm') {
		...
		} elseif (isset($this->request->get['news_subs'])) {
			$data['customer_group_id'] = (int) $this->request->get['news_subs'];
		} else {
	...
	private function validate() {
		...
		if (isset($this->request->post['customer_group_id']) && is_array($this->config->get('config_customer_group_display')) && in_array($this->request->post['customer_group_id'], $this->config->get('config_customer_group_display'))) {
			...
			$customer_group_id=(int)$this->request->get['news_subs'];
		} else {
