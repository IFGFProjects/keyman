...
class ControllerAccountWishList extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			if ($product_info) {
				...
				$data['products'][] = array(
					...
					'image'     =>  $this->model_tool_image->orig($product_info['image'])
				);
			} else {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/wishlist.tpl')) {
			return ($this->load->view($this->config->get('config_template') . '/template/account/wishlist.tpl', $data));
		} else {
			return ($this->load->view('default/template/account/wishlist.tpl', $data));
		}
	}
