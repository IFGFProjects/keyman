	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = array(
				...
				'adress_info' =>$result,
				'href' => $this->url->link('account/address/edit', 'address_id=' . $result['address_id'], 'SSL')
			);
		}
		...
		$data['cancel_href']=$this->url->link("account/account");
		$data['add_action'] = $this->url->link('account/address/add', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_list.tpl')) {
			return ($this->load->view($this->config->get('config_template') . '/template/account/address_list.tpl', $data));
		} else {
			return ($this->load->view('default/template/account/address_list.tpl', $data));
		}
	}
