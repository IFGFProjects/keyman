...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['tag']))
		{
			$data['tag_selected']=$this->request->get['tag'];
			$data['heading_title']=$this->request->get['tag'];
			$cat=$this->db->query('SELECT pc.category_id FROM product_description as pdesc
									JOIN product_to_category as pc ON pc.product_id=pdesc.product_id 
									WHERE pdesc.tag LIKE "%'.$this->db->escape($this->request->get['tag']).'%"
			...
			{
				$this->load->model("catalog/category");
				$data['tags']=$this->model_catalog_category->getCategoryTags($cat->row['category_id']);				
			}
		} 
