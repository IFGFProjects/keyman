...
class ControllerCatalogProduct extends Controller {
	...
	public function change_sort()
	{
		...
		{
			$this->db->query("UPDATE " . DB_PREFIX . "product SET sort_order=".(int)$this->request->get['sort_order']." WHERE product_id=".(int)$this->request->get['product_id']);
		}
	...
	protected function getList() {
		...
		$data['sync'] = $this->url->link('module/bitpro_sync', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['recheck'] = $this->url->link('module/bitpro_sync/RecheckDiscount', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
				...
				'change_sort'=> $this->url->link('catalog/product/change_sort', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, 'SSL'),
				'special'    => $special,
	...
	protected function getForm() {
		...
		if (isset($this->request->post['main_category_id'])) {
			...
			if ($product_info['main_category']!='')
			{

				$category_info = $this->model_catalog_category->getCategory($product_info['main_category']);

				if ($category_info)
					$data['main_category'] = ($category_info['path']) ? $category_info['path'] . ' &gt; ' . $category_info['name'] : $category_info['name'];
			$data['main_category_id'] = $product_info['main_category'];
			}
		}
