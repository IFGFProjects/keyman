...
class ControllerCatalogReview extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['answer_name'])) {
			$data['answer_name'] = $this->request->post['answer_name'];
		} elseif (!empty($review_info)) {
			$data['answer_name'] = $review_info['answer_name'];
		} else {
			$data['answer_name'] = '';
		}

		if (isset($this->request->post['answer_text'])) {
			$data['answer_text'] = $this->request->post['answer_text'];
		} elseif (!empty($review_info)) {
			$data['answer_text'] = $review_info['answer_text'];
		} else {
			$data['answer_text'] = '';
		}
