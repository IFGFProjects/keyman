...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_vacancies'] = "Вакансии";
		$data['text_catbrandinfo'] = "Таблицы размеров";
		...
		$data['text_blogtagsmgr']="Тэги БЛОГ, управление";
		$data['blogtagsmgr']=$this->url->link('module/blogtagsmgr', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['vacancies'] = $this->url->link('catalog/vacancies', 'token=' . $this->session->data['token'], 'SSL');
		$data['catbrandinfo'] = $this->url->link('module/catbrandinfo', 'token=' . $this->session->data['token'], 'SSL');
