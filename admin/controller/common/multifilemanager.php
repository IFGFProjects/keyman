...
class ControllerCommonMultifileManager extends Controller {
	public function index() {
		...
		$data['input_name'] = "product_image";
		
		if (strstr($this->request->server['HTTP_REFERER'], "blog/article"))
			{$data['input_name'] = "article_image";}

		if (strstr($this->request->server['HTTP_REFERER'], "hdesc/entry"))
			{$data['input_name'] = "entry_image";}
