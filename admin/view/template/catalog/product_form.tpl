        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-video_code"><?php echo $entry_video_code; ?></label>
                <div class="col-sm-10">
                  <textarea name="video_code" id="input-video_code" rows="5" class="form-control"><?php echo $video_code; ?></textarea>
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-main_category"><span data-toggle="tooltip" title="Главная категория">Главная категория</span></label>
                <div class="col-sm-10">
                  <input type="text" name="main_category" value="<?php echo $main_category; ?>" placeholder="Главная категория" id="input-main_category" class="form-control" />
