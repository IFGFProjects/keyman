      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-hcv" data-toggle="tab"><?php echo $hcv_tab_name; ?></a></li>
          </ul>
...
<!--               <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-add_data<?php echo $language['language_id']; ?>">Таблица размеров</label>
                <div class="col-sm-10">
                  <textarea name="category_description[<?php echo $language['language_id']; ?>][add_data]"  id="input-add_data<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['add_data'] : ''; ?></textarea>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Изображение для мобльной версии</label>
                <div class="col-sm-10">
                  <a href="" id="thumb-image-mobile" data-toggle="image" class="img-thumbnail" style="background-color: silver;">
                    <img  src="<?php echo $thumb_mobile; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />
                  </a>
                  <input type="hidden" name="image_mobile" value="<?php echo $image_mobile; ?>" id="input-image_mobile" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-is_complect"><span data-toggle="tooltip" title="Отметьте для того чтобы товарый это категории отображались как комплекты">Категория с комплектами</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($is_complect) { ?>
                      <input type="checkbox" name="is_complect" value="1" checked="checked" id="input-is_complect" />
                      <?php } else { ?>
                      <input type="checkbox" name="is_complect" value="1" id="input-is_complect" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-hcv">
                <?php echo $hcv_content; ?>
            </div>
...
<?php } ?>
<?php foreach ($languages as $language) { ?>
$('#input-add_data<?php echo $language['language_id']; ?>').summernote({
	height: 300
});
<?php } ?>
//--></script> 
