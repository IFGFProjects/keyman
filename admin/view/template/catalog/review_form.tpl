    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-image">Изображение (Фото)</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-age">Возраст</label>
            <div class="col-sm-10">
              <input type="text" name="age" value="<?php echo $age; ?>" placeholder="" id="input-age" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-answer_name">Имя специалиста (для ответа)</label>
            <div class="col-sm-10">
              <input type="text" name="answer_name" value="<?php echo $answer_name; ?>" placeholder="Менеджер магазина" id="input-answer_name" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-answer_text">Текст ответа специалиста</label>
            <div class="col-sm-10">
              <textarea name="answer_text" cols="60" rows="8" id="input-answer_text" placeholder="Текст" class="form-control"><?php echo $answer_text; ?></textarea>
            </div>
          </div>
          <div class="form-group">
