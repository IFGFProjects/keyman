	  ...
	  <div class="md_box">
		...
		<?php if($activated){ ?>
			<div class="mdp_tabs">
				...
				<div id="mdp_blog"><?php echo $text_tab_blog; ?></div>				
				<div id="mdp_hdesc"><?php echo $text_tab_hdesc; ?></div>				
			</div>		
			...
			<div class="mdp_tabs_data">
				...
				<div class="mdp_blog">
					<table class="form">
						<tr>
						  <td><a title="<?php echo $text_info_title; ?>"><?php echo $text_page; ?></a></td>
						  <td><?php if ($config_blog_page) { ?>
							<label><input type="radio" name="config_blog_page" value="1" checked="checked" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_blog_page" value="0" /><?php echo $text_no; ?></label>
							<?php } else { ?>
							<label><input type="radio" name="config_blog_page" value="1" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_blog_page" value="0" checked="checked" /><?php echo $text_no; ?></label>
							<?php } ?></td>
						</tr>
						<tr>
						  <td><a title="<?php echo $text_info_title; ?>"><?php echo $text_breadcrumb; ?></a></td>
						  <td><?php if ($config_blog_breadcrumb) { ?>
							<label><input type="radio" name="config_blog_breadcrumb" value="1" checked="checked" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_blog_breadcrumb" value="0" /><?php echo $text_no; ?></label>
							<?php } else { ?>
							<label><input type="radio" name="config_blog_breadcrumb" value="1" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_blog_breadcrumb" value="0" checked="checked" /><?php echo $text_no; ?></label>
							<?php } ?></td>
						</tr>						
						<tr>
						  <td><a title="<?php echo $text_info_title; ?>"><?php echo $text_syntax; ?></a></td>
						  <td>
							<select name="config_blog_syntax">
								<option value="all" <?php if($config_blog_syntax == 'all'){ ?>selected="selected"<?php } ?>><?php echo $text_company_syntax_all; ?></option>
								<option value="ld" <?php if($config_blog_syntax == 'ld'){ ?>selected="selected"<?php } ?>><?php echo $text_company_syntax_ld; ?></option>
								<option value="md" <?php if($config_blog_syntax == 'md'){ ?>selected="selected"<?php } ?>><?php echo $text_company_syntax_md; ?></option>
							</select>
						  </td>
						</tr>
					</table>
				...
				<div class="mdp_hdesc">
					<table class="form">
						<tr>
						  <td><a title="<?php echo $text_info_title; ?>"><?php echo $text_page; ?></a></td>
						  <td><?php if ($config_hdesc_page) { ?>
							<label><input type="radio" name="config_hdesc_page" value="1" checked="checked" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_hdesc_page" value="0" /><?php echo $text_no; ?></label>
							<?php } else { ?>
							<label><input type="radio" name="config_hdesc_page" value="1" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_hdesc_page" value="0" checked="checked" /><?php echo $text_no; ?></label>
							<?php } ?></td>
						</tr>
						<tr>
						  <td><a title="<?php echo $text_info_title; ?>"><?php echo $text_breadcrumb; ?></a></td>
						  <td><?php if ($config_hdesc_breadcrumb) { ?>
							<label><input type="radio" name="config_hdesc_breadcrumb" value="1" checked="checked" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_hdesc_breadcrumb" value="0" /><?php echo $text_no; ?></label>
							<?php } else { ?>
							<label><input type="radio" name="config_hdesc_breadcrumb" value="1" /><?php echo $text_yes; ?></label>
							<label><input type="radio" name="config_hdesc_breadcrumb" value="0" checked="checked" /><?php echo $text_no; ?></label>
							<?php } ?></td>
						</tr>						
						<tr>
						  <td><a title="<?php echo $text_info_title; ?>"><?php echo $text_syntax; ?></a></td>
						  <td>
							<select name="config_hdesc_syntax">
								<option value="all" <?php if($config_hdesc_syntax == 'all'){ ?>selected="selected"<?php } ?>><?php echo $text_company_syntax_all; ?></option>
								<option value="ld" <?php if($config_hdesc_syntax == 'ld'){ ?>selected="selected"<?php } ?>><?php echo $text_company_syntax_ld; ?></option>
								<option value="md" <?php if($config_hdesc_syntax == 'md'){ ?>selected="selected"<?php } ?>><?php echo $text_company_syntax_md; ?></option>
							</select>
						  </td>
						</tr>
					</table>
