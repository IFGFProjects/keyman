        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-article" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="status" id="input-status" class="form-control">
                    ...
                    <?php } else { ?>
                    <option value="1"><?php echo $text_statuses[1]; ?></option>
                    <option value="0" selected="selected"><?php echo $text_statuses[0]; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-menu_show"><?php echo $tag_text_menu_show; ?></label>
                <!-- menu_show: [<?php echo $menu_show;?>] -->
                <div class="col-sm-10">
                  <select name="menu_show" id="input-menu_show" class="form-control">
                    <?php if ($menu_show>0) { ?>
                    <option value="0"><?php echo $text_menu_shows[0]; ?></option>
                    <option value="1" selected="selected"><?php echo $text_menu_shows[1]; ?></option>
                    <?php } else { ?>
                    <option value="0" selected="selected"><?php echo $text_menu_shows[0]; ?></option>
                    <option value="1"><?php echo $text_menu_shows[1]; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
