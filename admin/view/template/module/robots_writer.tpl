      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
            <textarea name="text" id="" style="width:100%;" rows="20"><?php echo trim($text); ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="robots_writer_status" id="input-status" class="form-control">
                <?php if ($robots_writer_status) { ?>
