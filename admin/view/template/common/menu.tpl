<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $blogtagsmgr; ?>"><?php echo $text_blogtagsmgr; ?></a></li>

      <li><a href="<?php echo $vacancies; ?>"><?php echo $text_vacancies; ?></a></li>
      <li><a href="<?php echo $catbrandinfo; ?>"><?php echo $text_catbrandinfo; ?></a></li>
    </ul>
  </li>
