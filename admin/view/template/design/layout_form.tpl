...
function addRoute() {
	...
	<?php foreach ($stores as $store) { ?>
	html += '<option value="<?php echo $store['store_id']; ?>"><?php echo trim(addslashes($module['name'])); ?></option>';
	<?php } ?>   
	html += '  </select></td>';
...
function addModule() {
	...
	<?php foreach ($extensions as $extension) { ?>    
	<?php if (!$extension['module']) { ?>
	html += '    <option value="<?php echo $extension['code']; ?>"><?php echo trim(addslashes($module['name'])); ?></option>';
	<?php } else { ?>
	html += '    <optgroup label="<?php echo trim(addslashes($extension['name'])); ?>">';
	<?php foreach ($extension['module'] as $module) { ?>
	html += '      <option value="<?php echo $module['code']; ?>"><?php echo trim(addslashes($module['name'])); ?></option>';
	<?php } ?>
	html += '    </optgroup>';
	<?php } ?>
	<?php } ?>
