  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-customer').submit() : false;">
          <i class="fa fa-trash-o"></i>
        </button>
        <a href="<?php echo $import; ?>" data-toggle="tooltip" title="Импорт из файла" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
      </div>
...
<!--                   <td class="text-left"><?php if ($sort == 'customer_group') { ?>
              ...
              <tbody>
                <?php //echo "<h1 style='color:red;'>customers :</h1><pre>";print_r($customers);echo "</pre><hr>"; ?>
                <?php if ($customers) { ?>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['total_amount']; ?></td>
                  <td class="text-left"><?php echo $customer['discount']; ?></td>
                  <td class="text-left"><?php echo $customer['address']; ?></td>
                  <td class="text-left"><?php echo $customer['card_number']; ?></td>
