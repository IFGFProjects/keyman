                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-add_amount">Дополнительная сумма покупок</label>
                        <div class="col-sm-10">
                          <input type="text" name="add_amount" value="<?php echo $add_amount; ?>" placeholder="0" id="input-add_amount" class="form-control" />
                        </div>
                      </div>
