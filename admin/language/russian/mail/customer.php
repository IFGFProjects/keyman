...
$_['text_approve_login']        = 'Ваш аккаунт создан и Вы можете войти используя Ваши E-mail и пароль (vBwnVhxD), посетив наш сайт по адресу:';
$_['text_approve_services']     = 'После регистрации на сайте, Вы сможете воспользоваться дополнительными возможностями: просмотр истории заказов, изменение информации Вашей учетной записи и др.';
